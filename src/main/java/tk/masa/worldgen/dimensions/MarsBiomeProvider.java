...
public class MarsBiomeProvider extends BiomeSource {

    public static final Codec<MarsBiomeProvider> CODEC = RegistryLookupCodec.create(Registry.BIOME_REGISTRY)
            .xmap(MarsBiomeProvider::new, MarsBiomeProvider::getBiomeRegistry).codec();

    private final Biome biome;
    private final Registry<Biome> biomeRegistry;
    private static final List<ResourceKey<Biome>> SPAWN = Collections.singletonList(Biomes.PLAINS);

    public MarsBiomeProvider(Registry<Biome> biomeRegistry) {
