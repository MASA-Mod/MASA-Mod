...
import tk.masa.varia.CustomRenderType;

public class IronfurnaceRenderer implements BlockEntityRenderer<IronfurnaceBE> {
	public static final ResourceLocation HALO = new ResourceLocation(masa.MODID, "effect/halo");

    public IronfurnaceRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(IronfurnaceBE powergen, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
